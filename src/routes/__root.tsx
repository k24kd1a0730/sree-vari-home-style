    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">
          That corner of the showroom is empty
        </h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Sree Vari Furnitures — Offers & Catalogue" },
      {
        name: "description",
        content:
          "Handpicked teak and rosewood furniture from Sree Vari Furnitures. See today's offers, browse the catalogue, and walk away with something built to last.",
      },
      { name: "author", content: "Sree Vari Furnitures" },
      { property: "og:title", content: "Sree Vari Furnitures — Offers & Catalogue" },
      {
        property: "og:description",
        content:
          "Live offers and a full furniture catalogue from Sree Vari Furnitures.",
      },
